...
:: Android packaging
set AND_CERT_NAME="Bootje"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Bootje.p12
set AND_ICONS=icons/android

set AND_SIGNING_OPTIONS=-storetype pkcs12 -keystore "%AND_CERT_FILE%" -storepass %AND_CERT_PASS%

:: iOS packaging
set IOS_DIST_CERT_FILE=cert\iphone_dev_air.p12
set IOS_DEV_CERT_FILE=cert\iphone_dev_air.p12
set IOS_DEV_CERT_PASS=air232323
set IOS_PROVISION=cert\GameProvisioning.mobileprovision
...
set APP_ID=air.Bootje

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Bootje
